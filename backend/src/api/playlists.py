...
@playlists_bp.route('/api/profiles/<int:profile_id>/source/playlists', methods=['GET'])
...
@playlists_bp.route('/api/profiles/<int:profile_id>/source/playlists/<string:playlist_id>/tracks', methods=['GET'])
